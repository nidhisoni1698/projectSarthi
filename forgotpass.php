        ...
        <div class="col-md-4 col-10 box-shadow-2 p-0">
            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                ...
                <!--<div class="card-content">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="https://pixinvent.com/stack-responsive-bootstrap-4-admin-template/html/ltr/vertical-modern-menu-template/index.html" novalidate>
                            ...
                            <div class="form-group row">
                                ...
                                <h5 align="center"> Your password will be sent to the registered Email Id</h5>
                            </div>
