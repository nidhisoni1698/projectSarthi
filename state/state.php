      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-10 col-12 mb-2">
            <h3 class="content-header-title mb-0">State List</h3>
        ...
        <div class="modal fade text-left" id="defaultSize" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <form class="form-horizontal" action="state_add.php" method="post" novalidate>
            <div class="modal-body">
              ...
              <div class="form-group">
                <div class="controls">
                  <input type="text" name="state" class="form-control" placeholder="State Name" required data-validation-required-message="Enter State Name">
                </div>
              </div>
          	...
          	<div class="row">
          		<div class="col-12">
          			<div class="card">
                        ...
                        <?php
                          $i=1;
                          $state=mysqli_query($con, "select * from country_master c, state_master s where c.co_id=s.co_id order by s.st_id desc");
                          while($stat=mysqli_fetch_array($state))
                          {
                        ?>
          								<tr>
          									<td><?php echo $i; ?></td>
          									<td><?php echo $stat['st_name']; ?></td>
                            <td><?php echo $stat['co_name']; ?></td>
          									<td><a href="state_update.php?id=<?php echo $stat['st_id']; ?>" class="btn btn-outline-success mr-1"><i class="fa fa-pencil"></i></a>&nbsp;<a href="state_del.php?id=<?php echo $stat['st_id']; ?>" class="btn btn-outline-danger mr-1"><i class="fa fa-remove"></i></a></td>
          								</tr>
                        <?php $i++; } ?>
          							</tbody>
          						</table>				
